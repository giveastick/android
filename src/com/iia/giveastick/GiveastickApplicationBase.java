/**************************************************************************
 * GiveastickApplicationBase.java, giveastick Android
 *
 * Copyright 2014
 * Description : 
 * Author(s)   : Harmony
 ...
 * Harmony.
 * You should edit GiveastickApplication class instead of this
 * one or you will lose all your modifications.</i></b>
 *
 */
public abstract class GiveastickApplicationBase
	extends Application {

	/** TAG for debug purpose. */
	protected static final String TAG = "GiveastickApplication";
	/** Singleton. */
	private static volatile GiveastickApplicationBase singleton;
	/** Date format. */
	 ...
	 */
	private static void setSingleton(GiveastickApplicationBase application) {
		if (singleton == null) {
	 ...
	 */
	public static GiveastickApplicationBase getApplication() {
		return singleton;
	}
	...
	public static String getVersion(final Context ctx) {
		final SharedPreferences settings = ctx.getSharedPreferences(
				GiveastickApplicationBase.PREFS_PUBL,
				Context.MODE_WORLD_READABLE);

		return settings.getString(
				GiveastickApplicationBase.PREFS_VERS, "");
	}
